...
def main():
    ...
    # Wait for all capacities to finish resuming before creating workspaces
    log_info("Waiting 30s for capacities to be fully active...")
    time.sleep(30)
